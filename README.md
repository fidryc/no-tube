...
Микросервисная видеохостинг-платформа: загрузка видео, асинхронная транскодизация в DASH, подписки на авторов с платным доступом (YooKassa), OAuth-авторизация через Google и Яндекс, хранение в S3-хранилище. Бэкенд построен на FastAPI, тяжёлая обработка видео вынесена в отдельный сервис на Go.
